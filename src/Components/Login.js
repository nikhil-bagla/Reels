...
import {
    TextField, makeStyles, Grid, Button, Card,
...
import instaphones from "./Images/instaphones.png"
        ...
        <div className={classes.centerDivs}>
            <Container>
                <Grid container className={classes.alignCenter} spacing={2}>
                    <Grid item lg='4' className={classes.bimg} style={{
                        backgroundImage: `url(${instaphones})`,
                        backgroundSize: '55vh 35vw',
                        backgroundRepeat: 'no-repeat',
                        height: '80vh',
                    }}>

                        <Carousel className="cimages">
                            <Carousel.Item>
                                <img
                        ...
                        {/* <div id="carouselExampleSlidesOnly"  className="carousel slide cimages" data-ride="carousel">
                    ...
                    <Grid item sm={4}>
                        <Card variant="outlined">
                            ...
                            <CardActions>
                                <Button variant="contained" color="primary" onClick={handleLogin} disabled={loading} className={classes.fullWidth}>Login</Button>
                            </CardActions>
                        </Card>
