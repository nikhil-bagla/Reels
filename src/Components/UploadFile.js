...
function UploadFile(props){
    ...
    const types= ['video/mp4', 'video/weabm', 'video/ogg'];
    const onChange = (e) => {
        ...
        if (file.size / (1024 * 1024) > 100) {  //converts bytes into mbs then check if greater than 10mbs
        ...
        const uploadTask=storage.ref(`/post/${props.userData.userId}/${file.name}`).put(file)
